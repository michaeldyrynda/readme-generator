...
new Vue({
    ...
    ready: function ready() {
        ...
        new Clipboard('.clipper').on('success', function (e) {
            _this.outputCopied = true;
            _this.copiedMessage = 'Copied!';
        }).on('error', function (e) {
            _this.outputCopied = true;
            _this.copiedMessage = 'Press Cmd+C to copy';
        });
    },
    ...
    methods: {
        fetchRawMarkdown: function fetchRawMarkdown() {
...
},{"clipboard":2,"marked":7,"underscore":12,"vue":14,"vue-strap/dist/vue-strap.min":13}]},{},[15]);
